CREATE TABLE ria (
    id_ria SERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE ptd (
    id_ptd SERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE dia (
    id_dia INT NOT NULL PRIMARY KEY,/*nao é serial por causa do caio*/
...
CREATE TABLE ria_professor (
	id_ria_professor SERIAL NOT NULL PRIMARY KEY,
	id_ria INT NOT NULL,
...
CREATE TABLE ptd_professor (
	id_ptd_professor SERIAL NOT NULL PRIMARY KEY,
    id_professor INT NOT NULL,
    id_ptd INT NOT NULL,
...
CREATE TABLE professor_campus (
	id_professor_campus SERIAL NOT NULL PRIMARY KEY,
    id_professor INT NOT NULL,
    id_campus INT NOT NULL,
    FOREIGN KEY (id_campus) REFERENCES campus (id_campus),
    FOREIGN KEY (id_professor) REFERENCES professor (id_professor)
...
CREATE TABLE horario_aula (
    id_horario_aula SERIAL NOT NULL PRIMARY KEY,
